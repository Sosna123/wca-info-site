...
<div>
<button @click="compsShow = !compsShow" class="btn btn-outline-success m-2">Hide</button>
...
<!--* rank -->
<div>
<button @click="rankingsShow = !rankingsShow" class="btn btn-outline-success m-2">Hide</button>
...
<!--* results -->
<div>
<button @click="resultsShow = !resultsShow" class="btn btn-outline-success m-2">Hide</button>
